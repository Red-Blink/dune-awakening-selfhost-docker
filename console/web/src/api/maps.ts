...
export const mapsApi = {
  ...
  saveUserSettings: (body: { scope: "engine" | "global" | "map" | "partition"; map?: string; partitionId?: string; values: Record<string, string>; restart?: boolean }) => post<{ task: Task }>("/api/maps/user-settings/save", body),
